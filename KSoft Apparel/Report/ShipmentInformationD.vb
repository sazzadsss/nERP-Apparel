...
Public Class ShipmentInformationD
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ShipmentInformationD.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.ShipmentInformationD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShipmentInformationD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShipmentInformationD = New ShipmentInformationD()
        rpt.Site = Me.Site
        Return rpt
    End Function
