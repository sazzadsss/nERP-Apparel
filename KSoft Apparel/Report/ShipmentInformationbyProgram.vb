...
Public Class ShipmentInformationbyProgram
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ShipmentInformationbyProgram.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.ShipmentInformationbyProgram.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_BuyerCode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedShipmentInformationbyProgram
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShipmentInformationbyProgram = New ShipmentInformationbyProgram()
        rpt.Site = Me.Site
        Return rpt
    End Function
