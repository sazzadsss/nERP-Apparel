...
Public Class StyleCountByOrderRange
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StyleCountByOrderRange.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.StyleCountByOrderRange.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStyleCountByOrderRange
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StyleCountByOrderRange = New StyleCountByOrderRange()
        rpt.Site = Me.Site
        Return rpt
    End Function
