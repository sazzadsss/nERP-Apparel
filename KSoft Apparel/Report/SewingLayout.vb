...
Public Class SewingLayout
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.SewingLayout.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSewingLayout
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SewingLayout = New SewingLayout()
        rpt.Site = Me.Site
        Return rpt
    End Function
