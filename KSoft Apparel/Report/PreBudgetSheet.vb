...
Public Class PreBudgetSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreBudgetSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreBudgetSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreBudgetSheet = New PreBudgetSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
