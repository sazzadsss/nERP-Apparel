...
Public Class FabricConsumption2_IFL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FabricConsumption2-IFL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.FabricConsumption2-IFL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFabricConsumption2_IFL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FabricConsumption2_IFL = New FabricConsumption2_IFL()
        rpt.Site = Me.Site
        Return rpt
    End Function
