...
Public Class WashingWorkSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.WashingWorkSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWashingWorkSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WashingWorkSheet = New WashingWorkSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
