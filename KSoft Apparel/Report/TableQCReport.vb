...
Public Class TableQCReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.TableQCReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTableQCReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TableQCReport = New TableQCReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
