...
Public Class CuttingJobCardList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.CuttingJobCardList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCuttingJobCardList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CuttingJobCardList = New CuttingJobCardList()
        rpt.Site = Me.Site
        Return rpt
    End Function
