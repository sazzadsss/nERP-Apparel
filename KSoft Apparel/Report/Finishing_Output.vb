...
Public Class Finishing_Output
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.Finishing_Output.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinishing_Output
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Finishing_Output = New Finishing_Output()
        rpt.Site = Me.Site
        Return rpt
    End Function
