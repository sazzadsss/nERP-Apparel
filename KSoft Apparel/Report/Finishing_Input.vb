...
Public Class Finishing_Input
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.Finishing_Input.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinishing_Input
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Finishing_Input = New Finishing_Input()
        rpt.Site = Me.Site
        Return rpt
    End Function
