...
Public Class ActivitiesPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.ActivitiesPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedActivitiesPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ActivitiesPrint = New ActivitiesPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
