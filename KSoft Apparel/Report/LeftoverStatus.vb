...
Public Class LeftoverStatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.LeftoverStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLeftoverStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LeftoverStatus = New LeftoverStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
