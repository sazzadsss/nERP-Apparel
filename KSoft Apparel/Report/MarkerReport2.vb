...
Public Class MarkerReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.MarkerReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMarkerReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MarkerReport2 = New MarkerReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
