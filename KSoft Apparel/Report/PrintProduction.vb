...
Public Class PrintProduction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PrintProduction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrintProduction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintProduction = New PrintProduction()
        rpt.Site = Me.Site
        Return rpt
    End Function
