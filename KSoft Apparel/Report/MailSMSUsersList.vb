...
Public Class MailSMSUsersList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.MailSMSUsersList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMailSMSUsersList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MailSMSUsersList = New MailSMSUsersList()
        rpt.Site = Me.Site
        Return rpt
    End Function
