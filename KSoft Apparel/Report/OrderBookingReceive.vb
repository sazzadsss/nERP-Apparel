...
Public Class OrderBookingReceive
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OrderBookingReceive.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.OrderBookingReceive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrderBookingReceive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrderBookingReceive = New OrderBookingReceive()
        rpt.Site = Me.Site
        Return rpt
    End Function
