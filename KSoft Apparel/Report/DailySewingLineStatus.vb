...
Public Class DailySewingLineStatus
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DailySewingLineStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.DailySewingLineStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailySewingLineStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailySewingLineStatus = New DailySewingLineStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
