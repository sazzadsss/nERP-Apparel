...
Public Class AllProgramList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.AllProgramList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllProgramList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllProgramList = New AllProgramList()
        rpt.Site = Me.Site
        Return rpt
    End Function
