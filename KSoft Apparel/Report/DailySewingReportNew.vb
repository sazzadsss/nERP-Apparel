...
Public Class DailySewingReportNew
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DailySewingReportNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.DailySewingReportNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailySewingReportNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailySewingReportNew = New DailySewingReportNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
