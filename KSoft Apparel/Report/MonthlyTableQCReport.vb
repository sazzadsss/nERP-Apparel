...
Public Class MonthlyTableQCReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MonthlyTableQCReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.MonthlyTableQCReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyTableQCReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyTableQCReport = New MonthlyTableQCReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
