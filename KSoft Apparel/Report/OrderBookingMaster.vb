...
Public Class OrderBookingMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.OrderBookingMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrderBookingMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrderBookingMaster = New OrderBookingMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
