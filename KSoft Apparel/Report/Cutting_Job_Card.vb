...
Public Class Cutting_Job_Card
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.Cutting_Job_Card.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCutting_Job_Card
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cutting_Job_Card = New Cutting_Job_Card()
        rpt.Site = Me.Site
        Return rpt
    End Function
