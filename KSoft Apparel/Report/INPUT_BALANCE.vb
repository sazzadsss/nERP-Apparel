...
Public Class INPUT_BALANCE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.INPUT_BALANCE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedINPUT_BALANCE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As INPUT_BALANCE = New INPUT_BALANCE()
        rpt.Site = Me.Site
        Return rpt
    End Function
