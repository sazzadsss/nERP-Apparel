...
Public Class ShipmentInformationDOld
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ShipmentInformationDOld.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.ShipmentInformationDOld.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShipmentInformationDOld
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShipmentInformationDOld = New ShipmentInformationDOld()
        rpt.Site = Me.Site
        Return rpt
    End Function
