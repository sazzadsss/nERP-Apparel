...
Public Class OrderShippmentStatus
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OrderShippmentStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.OrderShippmentStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrderShippmentStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrderShippmentStatus = New OrderShippmentStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
