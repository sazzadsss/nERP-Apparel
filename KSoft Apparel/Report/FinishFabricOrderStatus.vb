...
Public Class FinishFabricOrderStatus
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FinishFabricOrderStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.FinishFabricOrderStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinishFabricOrderStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinishFabricOrderStatus = New FinishFabricOrderStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
