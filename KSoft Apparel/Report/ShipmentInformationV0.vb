...
Public Class ShipmentInformationV0
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ShipmentInformationV0.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.ShipmentInformationV0.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShipmentInformationV0
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShipmentInformationV0 = New ShipmentInformationV0()
        rpt.Site = Me.Site
        Return rpt
    End Function
