...
Public Class PrintWorkOrderNo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PrintWorkOrderNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrintWorkOrderNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintWorkOrderNo = New PrintWorkOrderNo()
        rpt.Site = Me.Site
        Return rpt
    End Function
