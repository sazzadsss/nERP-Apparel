...
Public Class DailyTabeQCReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.DailyTabeQCReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyTabeQCReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyTabeQCReport = New DailyTabeQCReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
