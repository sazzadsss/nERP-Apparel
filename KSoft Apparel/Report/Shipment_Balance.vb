...
Public Class Shipment_Balance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.Shipment_Balance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShipment_Balance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Shipment_Balance = New Shipment_Balance()
        rpt.Site = Me.Site
        Return rpt
    End Function
