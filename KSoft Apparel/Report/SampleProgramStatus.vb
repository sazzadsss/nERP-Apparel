...
Public Class SampleProgramStatus
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SampleProgramStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.SampleProgramStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSampleProgramStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SampleProgramStatus = New SampleProgramStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
