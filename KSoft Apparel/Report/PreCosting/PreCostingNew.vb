...
Public Class PreCostingNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreCostingNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreCostingNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreCostingNew = New PreCostingNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
