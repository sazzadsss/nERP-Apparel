...
Public Class PreCostingNewV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreCostingNewV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreCostingNewV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreCostingNewV1 = New PreCostingNewV1()
        rpt.Site = Me.Site
        Return rpt
    End Function
