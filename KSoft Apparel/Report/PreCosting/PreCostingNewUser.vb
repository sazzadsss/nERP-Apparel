...
Public Class PreCostingNewUser
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreCostingNewUser.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreCostingNewUser
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreCostingNewUser = New PreCostingNewUser()
        rpt.Site = Me.Site
        Return rpt
    End Function
