...
Public Class PreCostingList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreCostingList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreCostingList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreCostingList = New PreCostingList()
        rpt.Site = Me.Site
        Return rpt
    End Function
