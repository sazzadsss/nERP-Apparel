...
Public Class PreCostingNewA4V4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreCostingNewA4V4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreCostingNewA4V4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreCostingNewA4V4 = New PreCostingNewA4V4()
        rpt.Site = Me.Site
        Return rpt
    End Function
