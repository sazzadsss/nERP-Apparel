...
Public Class PreCostingNewV3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreCostingNewV3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreCostingNewV3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreCostingNewV3 = New PreCostingNewV3()
        rpt.Site = Me.Site
        Return rpt
    End Function
