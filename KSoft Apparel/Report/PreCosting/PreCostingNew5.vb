...
Public Class PreCostingNew5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreCostingNew5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreCostingNew5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreCostingNew5 = New PreCostingNew5()
        rpt.Site = Me.Site
        Return rpt
    End Function
