...
Public Class PreCostingNewV2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreCostingNewV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreCostingNewV2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreCostingNewV2 = New PreCostingNewV2()
        rpt.Site = Me.Site
        Return rpt
    End Function
