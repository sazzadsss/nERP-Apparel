...
Public Class PreCostingNewV0
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreCostingNewV0.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreCostingNewV0
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreCostingNewV0 = New PreCostingNewV0()
        rpt.Site = Me.Site
        Return rpt
    End Function
