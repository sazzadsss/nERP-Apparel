...
Public Class PreCostingNewA4V1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.PreCostingNewA4V1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreCostingNewA4V1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreCostingNewA4V1 = New PreCostingNewA4V1()
        rpt.Site = Me.Site
        Return rpt
    End Function
