...
Public Class MasterOrderPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.MasterOrderPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMasterOrderPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MasterOrderPrint = New MasterOrderPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
