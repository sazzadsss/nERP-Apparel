...
Public Class ShipmentInformationOldd
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ShipmentInformationOldd.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.ShipmentInformationOldd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShipmentInformationOldd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShipmentInformationOldd = New ShipmentInformationOldd()
        rpt.Site = Me.Site
        Return rpt
    End Function
