...
Public Class BonusTopSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.BonusTopSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBonusTopSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BonusTopSheet = New BonusTopSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
