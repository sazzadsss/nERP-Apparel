...
Public Class MonthlyBonusTopSheet
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MonthlyBonusTopSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.MonthlyBonusTopSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyBonusTopSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyBonusTopSheet = New MonthlyBonusTopSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
