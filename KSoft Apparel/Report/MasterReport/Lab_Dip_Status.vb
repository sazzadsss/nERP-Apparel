...
Public Class Lab_Dip_Status
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.Lab_Dip_Status.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLab_Dip_Status
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Lab_Dip_Status = New Lab_Dip_Status()
        rpt.Site = Me.Site
        Return rpt
    End Function
