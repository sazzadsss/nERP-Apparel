...
Public Class KnittingWorkOrderProgramwise
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "KnittingWorkOrderProgramwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Apparel.KnittingWorkOrderProgramwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKnittingWorkOrderProgramwise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As KnittingWorkOrderProgramwise = New KnittingWorkOrderProgramwise()
        rpt.Site = Me.Site
        Return rpt
    End Function
