Public Class frmBTBReporter

    Private Sub frmBTBReporter_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load


        Me.BTBReporterTableAdapter.Fill(Me.BTBReporterDataSet.BTBReporter)
