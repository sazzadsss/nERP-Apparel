...
Partial Public Class CustomerListDataSet
    ...
    Partial Public Class CustomerListDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddCustomerListRow(ByVal CustomerName As String, ByVal ContactPerson As String, ByVal ContactNo As String, ByVal Add1 As String, ByVal Add2 As String, ByVal City As String, ByVal Country As String, ByVal CustomerCode As String) As CustomerListRow
            Dim rowCustomerListRow As CustomerListRow = CType(Me.NewRow,CustomerListRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, CustomerName, ContactPerson, ContactNo, Add1, Add2, City, Country, CustomerCode}
        ...
        Private Sub InitClass()
            ...
            Me.columnCustomerCode.MaxLength = 3
        End Sub
    ...
    Partial Public Class CustomerListRow
        ...
        Public Property CustomerCode() As String
            Get
                Try 
                    Return CType(Me(Me.tableCustomerList.CustomerCodeColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'CustomerCode' in table 'CustomerList' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableCustomerList.CustomerCodeColumn) = value
            End Set
        End Property
        ...
        Public Function IsCustomerCodeNull() As Boolean
            Return Me.IsNull(Me.tableCustomerList.CustomerCodeColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetCustomerCodeNull()
            Me(Me.tableCustomerList.CustomerCodeColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace CustomerListDataSetTableAdapters
    ...
    Partial Public Class CustomerListTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [CustomerList] WHERE (([CustomerId] = @Original_CustomerId) AND ((@Is"& _ 
                "Null_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original"& _ 
                "_CustomerName)) AND ((@IsNull_ContactPerson = 1 AND [ContactPerson] IS NULL) OR "& _ 
                "([ContactPerson] = @Original_ContactPerson)) AND ((@IsNull_ContactNo = 1 AND [Co"& _ 
                "ntactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_Add1 = 1"& _ 
                " AND [Add1] IS NULL) OR ([Add1] = @Original_Add1)) AND ((@IsNull_Add2 = 1 AND [A"& _ 
                "dd2] IS NULL) OR ([Add2] = @Original_Add2)) AND ((@IsNull_City = 1 AND [City] IS"& _ 
                " NULL) OR ([City] = @Original_City)) AND ((@IsNull_Country = 1 AND [Country] IS "& _ 
                "NULL) OR ([Country] = @Original_Country)) AND ((@IsNull_CustomerCode = 1 AND [Cu"& _ 
                "stomerCode] IS NULL) OR ([CustomerCode] = @Original_CustomerCode)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [CustomerList] ([CustomerName], [ContactPerson], [ContactNo], [Add1],"& _ 
                " [Add2], [City], [Country], [CustomerCode]) VALUES (@CustomerName, @ContactPerso"& _ 
                "n, @ContactNo, @Add1, @Add2, @City, @Country, @CustomerCode);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerId"& _ 
                ", CustomerName, ContactPerson, ContactNo, Add1, Add2, City, Country, CustomerCod"& _ 
                "e FROM CustomerList WHERE (CustomerId = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [CustomerList] SET [CustomerName] = @CustomerName, [ContactPerson] = @Cont"& _ 
                "actPerson, [ContactNo] = @ContactNo, [Add1] = @Add1, [Add2] = @Add2, [City] = @C"& _ 
                "ity, [Country] = @Country, [CustomerCode] = @CustomerCode WHERE (([CustomerId] ="& _ 
                " @Original_CustomerId) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL"& _ 
                ") OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_ContactPerson = 1 "& _ 
                "AND [ContactPerson] IS NULL) OR ([ContactPerson] = @Original_ContactPerson)) AND"& _ 
                " ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_Co"& _ 
                "ntactNo)) AND ((@IsNull_Add1 = 1 AND [Add1] IS NULL) OR ([Add1] = @Original_Add1"& _ 
                ")) AND ((@IsNull_Add2 = 1 AND [Add2] IS NULL) OR ([Add2] = @Original_Add2)) AND "& _ 
                ...
                "@IsNull_CustomerCode = 1 AND [CustomerCode] IS NULL) OR ([CustomerCode] = @Origi"& _ 
                "nal_CustomerCode)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerId, CustomerName, ContactPerson, ContactNo,"& _ 
                " Add1, Add2, City, Country, CustomerCode FROM CustomerList WHERE (CustomerId = @"& _ 
                "CustomerId)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        CustomerId, CustomerName, ContactPerson, ContactNo, Add1, Add2, Cit"& _ 
                "y, Country, CustomerCode"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            CustomerList"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CustomerId As Long, ByVal Original_CustomerName As String, ByVal Original_ContactPerson As String, ByVal Original_ContactNo As String, ByVal Original_Add1 As String, ByVal Original_Add2 As String, ByVal Original_City As String, ByVal Original_Country As String, ByVal Original_CustomerCode As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(16).Value = CType(Original_CustomerCode,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal CustomerName As String, ByVal ContactPerson As String, ByVal ContactNo As String, ByVal Add1 As String, ByVal Add2 As String, ByVal City As String, ByVal Country As String, ByVal CustomerCode As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(7).Value = CType(CustomerCode,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(CustomerCode,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_CustomerId,Long)
            If (Original_CustomerName Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(24).Value = CType(Original_CustomerCode,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(25).Value = CType(CustomerId,Long)
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_City As String,  _
                    ByVal Original_Country As String,  _
                    ByVal Original_CustomerCode As String) As Integer
            Return Me.Update(CustomerName, ContactPerson, ContactNo, Add1, Add2, City, Country, CustomerCode, Original_CustomerId, Original_CustomerName, Original_ContactPerson, Original_ContactNo, Original_Add1, Original_Add2, Original_City, Original_Country, Original_CustomerCode, Original_CustomerId)
        End Function
    End Class
