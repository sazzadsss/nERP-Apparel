...
Partial Public Class ItemListLookupDataSet
    ...
    Partial Public Class ItemListDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddItemListRow(ByVal ItemName As String, ByVal DepartmentId As Long, ByVal UnitId As Long, ByVal UnitCode As String) As ItemListRow
            Dim rowItemListRow As ItemListRow = CType(Me.NewRow,ItemListRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, ItemName, DepartmentId, UnitId, UnitCode}
    ...
    Partial Public Class ItemListRow
        ...
        Public Property UnitCode() As String
            Get
                Try 
                    Return CType(Me(Me.tableItemList.UnitCodeColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'UnitCode' in table 'ItemList' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableItemList.UnitCodeColumn) = value
            End Set
        End Property
        ...
        Public Function IsUnitCodeNull() As Boolean
            Return Me.IsNull(Me.tableItemList.UnitCodeColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetUnitCodeNull()
            Me(Me.tableItemList.UnitCodeColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace ItemListLookupDataSetTableAdapters
    ...
    Partial Public Class ItemListTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ItemList.ItemId, ItemList.ItemName, ItemList.DepartmentId, ItemList"& _ 
                ".UnitId, Unit.UnitCode"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            ItemList LEFT OUTER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"              "& _ 
                "           Unit ON ItemList.UnitId = Unit.UnitId"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (ItemList.Departm"& _ 
                "entId = @DepartmentId)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY ItemList.ItemName"
            ...
            Me._commandCollection(1).CommandText = "SELECT        ItemList.ItemId, ItemList.ItemName, ItemList.DepartmentId, Unit.Uni"& _ 
                "tCode, ItemList.UnitId"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            ItemList INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                   "& _ 
                "      Unit ON ItemList.UnitId = Unit.UnitId"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY ItemList.ItemName"
        ...
        Public Overloads Overridable Function GetData(ByVal DepartmentId As Long) As ItemListLookupDataSet.ItemListDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(DepartmentId,Long)
            Dim dataTable As ItemListLookupDataSet.ItemListDataTable = New ItemListLookupDataSet.ItemListDataTable()
