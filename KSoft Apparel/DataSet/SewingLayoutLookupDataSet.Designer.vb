...
Partial Public Class SewingLayoutLookupDataSet
    ...
    Partial Public Class SewingLayoutDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddSewingLayoutRow(ByVal SewingLayoutNo As String, ByVal OrderId As Long, ByVal LayoutDate As Date, ByVal StyleName As String) As SewingLayoutRow
            Dim rowSewingLayoutRow As SewingLayoutRow = CType(Me.NewRow,SewingLayoutRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, SewingLayoutNo, OrderId, LayoutDate, StyleName}
    ...
    Partial Public Class SewingLayoutRow
        ...
        Public Property StyleName() As String
            Get
                Try 
                    Return CType(Me(Me.tableSewingLayout.StyleNameColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'StyleName' in table 'SewingLayout' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableSewingLayout.StyleNameColumn) = value
            End Set
        End Property
        ...
        Public Function IsStyleNameNull() As Boolean
            Return Me.IsNull(Me.tableSewingLayout.StyleNameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetStyleNameNull()
            Me(Me.tableSewingLayout.StyleNameColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace SewingLayoutLookupDataSetTableAdapters
    ...
    Partial Public Class SewingLayoutTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        SewingLayout.LayoutId, SewingLayout.SewingLayoutNo, SewingLayout.Or"& _ 
                "derId, SewingLayout.LayoutDate, Style.StyleName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            SewingLayout LE"& _ 
                "FT OUTER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Style ON SewingLayout.StyleId = Style.St"& _ 
                "yleId"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        SewingLayout.LayoutId, SewingLayout.SewingLayoutNo, SewingLayout.Or"& _ 
                "derId, SewingLayout.LayoutDate, Style.StyleName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            SewingLayout LE"& _ 
                "FT OUTER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Style ON SewingLayout.StyleId = Style.St"& _ 
                "yleId"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (SewingLayout.OrderId = @OrderId)"
        ...
        Public Overloads Overridable Function FillByOrderId(ByVal dataTable As SewingLayoutLookupDataSet.SewingLayoutDataTable, ByVal OrderId As Global.System.Nullable(Of Long)) As Integer
        ...
        Public Overloads Overridable Function GetDataByOrderId(ByVal OrderId As Global.System.Nullable(Of Long)) As SewingLayoutLookupDataSet.SewingLayoutDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (OrderId.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(OrderId.Value,Long)
            Else
