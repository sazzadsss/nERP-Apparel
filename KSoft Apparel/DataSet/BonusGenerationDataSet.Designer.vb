...
Namespace BonusGenerationDataSetTableAdapters
    ...
    Partial Public Class SewingProductionTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        SewingProduction.SewingDate, SewingProduction.LineId, SewingProduct"& _ 
                "ion.OrderId, SUM(SewingProduction.OutputQuantity) AS OutputQuantity, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"         "& _ 
                "                MAX(SewingProduction.WorkingHour) AS WorkingHour, SewingProducti"& _ 
                "on.BranchId, SewingProduction.SewingLayoutId, MAX(SewingProduction.LossHour) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" "& _ 
                "                        AS LossHour, MAX(SewingProduction.SewingId) AS SewingId"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            SewingProduction INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         SewingPro"& _ 
                ...
                "SewingId"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"GROUP BY SewingProduction.SewingDate, SewingProduction.LineId, SewingP"& _ 
                "roduction.OrderId, SewingProduction.BranchId, SewingProduction.SewingLayoutId"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"H"& _ 
                "AVING        (SewingProduction.SewingLayoutId IN (@SewingLayoutId, @Sewinglayout"& _ 
                "Id2))"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY SewingProduction.SewingDate"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@SewingLayoutId", Global.System.Data.SqlDbType.BigInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@SewinglayoutId2", Global.System.Data.SqlDbType.BigInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function FillByDoubleLayout(ByVal dataTable As BonusGenerationDataSet.SewingProductionDataTable, ByVal SewingLayoutId As Long, ByVal SewinglayoutId2 As Long) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(SewingLayoutId,Long)
            Me.Adapter.SelectCommand.Parameters(1).Value = CType(SewinglayoutId2,Long)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
            Dim returnValue As Integer = Me.Adapter.Fill(dataTable)
        ...
        Public Overloads Overridable Function GetDataByDoubleLayout(ByVal SewingLayoutId As Long, ByVal SewinglayoutId2 As Long) As BonusGenerationDataSet.SewingProductionDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(SewingLayoutId,Long)
            Me.Adapter.SelectCommand.Parameters(1).Value = CType(SewinglayoutId2,Long)
            Dim dataTable As BonusGenerationDataSet.SewingProductionDataTable = New BonusGenerationDataSet.SewingProductionDataTable()
