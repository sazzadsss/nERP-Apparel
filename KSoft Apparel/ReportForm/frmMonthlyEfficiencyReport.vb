Public Class frmMonthlyEfficiencyReport
    ...
    Private Sub frmMonthlyEfficiencyReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Me.ActiveMonthTableAdapter.Fill(Me.ActiveMonthDataSet.ActiveMonth)
        CrystalReportViewer1.RefreshReport()
    End Sub

    Private Sub ActiveMonthBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs) Handles ActiveMonthBindingNavigatorSaveItem.Click
