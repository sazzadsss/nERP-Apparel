Public Class frmKnittingProduction_mrf
    ...
    Private Sub FrmKnittingProduction_mrf_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim MyReport As CrystalDecisions.CrystalReports.Engine.ReportDocument = New KnittingProductionReportCompactProgramwise
